        ...
        <div class="widget-content">
          <div class="padd">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <input type="text" name="txtCateName" class="form-control" placeholder="Input Box">
              </div>
            </div> 
            ...
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <textarea class="form-control" rows="2" name="txtDescription" placeholder="Textarea"></textarea>
              </div>
            </div>    
            ...
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <div class="radio">
                  <label>
                    <input type="radio" name="optionsType" id="optionsRadios1" value="1" checked>
                    BDS Bán
                  </label>
                </div>
                <div class="radio">
                  <label>
                    <input type="radio" name="optionsType" id="optionsRadios2" value="2">
                    BDS Cho thuê
                  </label>
                </div>
              </div>
        ...
        <div class="widget-content">
          <div class="padd">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <textarea class="form-control" name="txtMeta" rows="2" placeholder="Textarea"></textarea>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-lg-9">
                <input type="text" name="tags" class="form-control" placeholder="Input Box">
              </div>
            </div> 
